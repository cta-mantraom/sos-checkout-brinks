...
const features = [
  {
    ...
    description: 'Acesso instantâneo às suas informações médicas em emergências'
  },
  {
...
const testimonials = [
  {
    ...
    content: 'O SOS Checkout revolucionou o atendimento de emergência. Acesso rápido às informações vitais salva vidas.',
    rating: 5
  },
  {
    name: 'Maria Santos',
    role: 'Usuária Premium',
    content: 'Como diabética, ter minhas informações sempre acessíveis me dá muita segurança. Recomendo!',
    rating: 5
  },
  {
    name: 'João Oliveira',
    role: 'Usuário Básico',
    content: 'Fácil de usar e muito útil. Já salvou minha vida quando tive uma reação alérgica.',
    rating: 5
  }
];
          ...
          <div className="text-center space-y-8">
            <div className="space-y-4">
              ...
              <p className="text-xl text-muted-foreground max-w-3xl mx-auto">
                Tenha acesso rápido e seguro ao seu perfil médico em emergências. 
                QR Code personalizado com todas as informações vitais para salvar vidas.
              </p>
            </div>
              ...
              <Card key={index} className={cn(
                ...
                <CardContent className="space-y-6">
                  ...
                  <Button 
                    ...
                    size="lg"
                  >
                    <Link to="/medical-form" state={{ selectedPlan: plan.name.toLowerCase() }}>
                      Começar Agora
                    </Link>
                  </Button>
                </CardContent>
      ...
      <section className="px-4 py-16 md:py-24 bg-primary text-primary-foreground">
        <div className="max-w-4xl mx-auto text-center space-y-8">
          ...
          <p className="text-xl opacity-90">
            Junte-se a milhares de pessoas que já protegem suas informações médicas conosco.
            Comece hoje mesmo e tenha peace of mind em qualquer emergência.
          </p>
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
        ...
        <div className="max-w-7xl mx-auto">
          <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
            <div className="space-y-4">
              ...
              <p className="text-sm">
                Suas informações médicas seguras e acessíveis em qualquer emergência.
              </p>
            </div>
            ...
            <div className="space-y-4">
              ...
              <ul className="space-y-2 text-sm">
                <li><Link to="/medical-form" className="hover:text-white">Criar Perfil</Link></li>
            ...
            <div className="space-y-4">
              ...
              <ul className="space-y-2 text-sm">
                <li><a href="mailto:suporte@soscheckout.com" className="hover:text-white">Contato</a></li>
