...
export class MercadoPagoClient implements IMercadoPagoClient {
  ...
  // ✅ MODO DIRETO: Payment Brick processa pagamentos diretamente no MercadoPago
  // Backend APENAS valida pagamentos já criados usando getPaymentById()
  // ❌ NUNCA implementar createPayment() aqui - causaria duplicação de processamento
